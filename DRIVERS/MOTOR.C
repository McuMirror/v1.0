...
*****************************************************************************************************************************************/
unsigned char MotorVending(unsigned int channel)
{
	return MotorSensorRead();
}
/*****************************************************************************************************************************************
...
static void MotorRowCtrl(unsigned char ctrl)
{
	...
	{
		case 0x00:
			LPC_GPIO1->FIOCLR |= (MOTORCTRL_ROW1 | MOTORCTRL_ROW2 | MOTORCTRL_ROW3 | MOTORCTRL_ROW4 | MOTORCTRL_ROW5);
			LPC_GPIO1->FIOSET |= MOTORCTRL_ROW0;
			break;
		case 0x01:
			LPC_GPIO1->FIOCLR |= (MOTORCTRL_ROW0 | MOTORCTRL_ROW2 | MOTORCTRL_ROW3 | MOTORCTRL_ROW4 | MOTORCTRL_ROW5);
			LPC_GPIO1->FIOSET |= MOTORCTRL_ROW1;
			break;
		case 0x02:
			LPC_GPIO1->FIOCLR |= (MOTORCTRL_ROW1 | MOTORCTRL_ROW0 | MOTORCTRL_ROW3 | MOTORCTRL_ROW4 | MOTORCTRL_ROW5);
			LPC_GPIO1->FIOSET |= MOTORCTRL_ROW2;
			break;
		case 0x03:
			LPC_GPIO1->FIOCLR |= (MOTORCTRL_ROW1 | MOTORCTRL_ROW2 | MOTORCTRL_ROW0 | MOTORCTRL_ROW4 | MOTORCTRL_ROW5);
			LPC_GPIO1->FIOSET |= MOTORCTRL_ROW3;
			break;
		case 0x04:
			LPC_GPIO1->FIOCLR |= (MOTORCTRL_ROW1 | MOTORCTRL_ROW2 | MOTORCTRL_ROW3 | MOTORCTRL_ROW0 | MOTORCTRL_ROW5);
			LPC_GPIO1->FIOSET |= MOTORCTRL_ROW4;
			break;
		case 0x05:
			LPC_GPIO1->FIOCLR |= (MOTORCTRL_ROW1 | MOTORCTRL_ROW2 | MOTORCTRL_ROW3 | MOTORCTRL_ROW4 | MOTORCTRL_ROW0);
			LPC_GPIO1->FIOSET |= MOTORCTRL_ROW5;
			break;
		default:
			LPC_GPIO1->FIOCLR |= (MOTORCTRL_ROW1 | MOTORCTRL_ROW2 | MOTORCTRL_ROW3 | MOTORCTRL_ROW4 | MOTORCTRL_ROW5);
...
static unsigned char MotorSensorRead(void)
{
	...
	return(((LPC_GPIO0->FIOPIN) >> 18) & 0x01);
}
/**************************************End Of File***************************************************************************************/
